...
import { ProjectsWidgetData } from 'src/views/dashboard/useModernDashboardData';


type ProjectsProps = {
  data?: ProjectsWidgetData;
};

const defaultData: ProjectsWidgetData = {
  totalTasks: 0,
  resolutionPercent: 0,
  barSeries: [0, 0, 0, 0, 0, 0],
};

const Projects = ({ data = defaultData }: ProjectsProps) => {
  // chart color
