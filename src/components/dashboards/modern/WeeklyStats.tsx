...
import { WeeklyWidgetData } from 'src/views/dashboard/useModernDashboardData';

type WeeklyStatsProps = {
  data?: WeeklyWidgetData;
};

const defaultData: WeeklyWidgetData = {
  sparkline: [0, 0, 0, 0, 0],
  stats: [],
};

const WeeklyStats: React.FC<WeeklyStatsProps> = ({ data = defaultData }) => {
  // chart color
