...
const CreateInvoice = () => {
  ...
  const calculateTotals = (orders: any[]) => {
    ...
    orders.forEach((order) => {
      ...
      const totalCost = roundToTwo(unitPrice * units);
    ...
    const vat = roundToTwo(subtotal * 0.1);
    const grandTotal = roundToTwo(subtotal + vat);
      ...
      <Box>
        ...
        <Box p={3} bgcolor="primary.light" mt={3}>
          <Box display="flex" justifyContent="end" gap={3} mb={3}>
            ...
            <Typography variant="body1" fontWeight={600}>
              {formatAmount(formData.subtotal)}
            </Typography>
          </Box>
          <Box display="flex" justifyContent="end" gap={3} mb={3}>
            <Typography variant="body1" fontWeight={600}>
          ...
          <Box display="flex" justifyContent="end" gap={3}>
            ...
            <Typography variant="body1" fontWeight={600}>
              {formatAmount(formData.grandTotal)}
            </Typography>
          </Box>
        </Box>
