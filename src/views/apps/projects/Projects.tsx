    ...
    <PageContainer title="Projects App" description="Manage projects and assignments">
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" alignItems={{ sm: 'center' }} spacing={2}>
            ...
            {canWrite ? (
              ...
              <Typography variant="body2" color="textSecondary">
                Your role is read-only for project management.
              </Typography>
            )}
          </Stack>
      ...
      <Dialog open={formOpen} onClose={() => setFormOpen(false)} fullWidth maxWidth="sm">
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={saveProject} disabled={saving || !form.name.trim()}>
            {saving ? 'Saving...' : 'Save'}
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={membersOpen} onClose={() => setMembersOpen(false)} fullWidth maxWidth="sm">
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={saveMembers} disabled={savingMembers || !canWrite}>
